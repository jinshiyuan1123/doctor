    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav" id="menu-nav">
                <?php if(is_array($menu1)): foreach($menu1 as $key=>$v): ?><li class="li-menu"><a href="<?php echo U($v[menu_name]);?>" class="menu" id="<?php echo ($v["id"]); ?>" p-id="<?php echo ($v["pid"]); ?>" target="main"><i class="fa fa-medkit"></i> <span><?php echo ($v["title"]); ?>33</span></a></li><?php endforeach; endif; ?>
            </ul>
        </nav>
    </div>
</div>
