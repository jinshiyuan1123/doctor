...
<div class="g-container new-account-ui new-doctor-register J_NewRegister" id="gc" data-module="account">
	...
	<div class="main-box J_MainBox">
		...
		<div class="reg-link">
			<a href="/register/mobile">我是用户，用户注册<i></i></a>
		</div>
		<div class="form-container">
			<form id="userForm" name="userForm" method="post" onsubmit="return checkPost()" action="<?php echo U('home/index/yydoctorsubmit');?>">
				...
				<ul>
					...
					<li class="agreement">
						...
						<p class="agreement-content policy-info">
							<a href="<?php echo U('home/index/doctorlist');?>" target="_blank" class="Textr">《择医医院注册协议》</a>
