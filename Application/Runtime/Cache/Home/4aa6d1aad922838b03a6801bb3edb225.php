...
<head>
	...
	<title>用户注册协议 | 择医(挂号网)-互联网医院在线诊疗平台</title>
			   	<meta name="keywords" content="择医用户注册协议,挂号网用户注册协议" />
			   	<meta name="description" content="择医（挂号网）用户注册协议 - 择医（www.guahao.com）致力于打造实名医患交流的互联网健康服务平台。聚合了全国超过3900家重点医院，建立了全国三级医院30万名医生的专长库，是您合作的首选平台。" />
		...
		<div class="list-right">
			<div class="list-right-content">
				...
				<div class="agreementCenter">
				    ...
				    <p>1、《择医用户注册协议》（以下简称“本协议”）是您与择医订立的关于您使用择医平台的协议。</p>
					...
					<p>5、“用户”是指择医平台服务的使用人，在本协议中更多地称为“您”或“用户”。</p>
					...
					<p>3、如果您在18周岁以下，您只能在父母或监护人的监护参与下才能使用择医平台。</p>
					<p>4、择医保留在中华人民共和国大陆地区法施行之法律允许的范围内独自决定拒绝服务、关闭用户账户、清除或编辑内容或取消订单的权利。</p>
					<p>5、择医运用自己的操作系统通过国际互联网为您提供各项电子服务，并承担本协议和其它服务协议中对您的责任和义务。为使用本服务，您必须能够自行通过有法律资格的第三方对您提供互联网接入服务，并自行承担以下内容：
					<p>(1)自行配备上网所需的设备，包括个人电脑，调制解调器及其他必要的设备装置。</p>
					<p>(2)自行承担上网所需的相关必要费用，如：电话费用、网络费用等。</p>
					<p>(3)本协议中规定的您的其他责任和义务。</p></p>
					<p>6、您应保证：提供详尽、真实、准确和完整的个人资料以符合实名认证的要求。如果资料发生变动，您应及时更改。若您提供任何错误、不实、过时或不完整的资料，并为择医所确知，或者择医有合理理由怀疑前述资料为错误、不实、过时或不完整的资料，择医有权暂停或终止您的帐号，并拒绝现在或将来申请使用本服务的全部或一部分的请求。在此情况下，您可通过择医的申诉途径与择医取得联系并修正个人资料经择医核实后恢复账号使用。</p>
					...
					<p>12、您的授权行为：用户同意授权择医获取患者数据，并为患者服务的目的使用所有就诊数据，包括用户在其他实体医疗机构的数据。</p>
					<p>13、根据相关法律法规规定，用户应理解互联网诊疗不涉及面诊、触诊、初诊，医生仅根据患者提供的信息和初诊数据提供复诊服务。</p>


					<p class="agreement-title">五、用户责任</p>
					<p>1、您同意保障和维护择医的利益，如果因为您违反有关法律、法规或本协议的任何规定而给择医、择医生或任何其他第三方造成任何损失，您统一承担由此产生的损害赔偿责任，其中包括择医为此而支付的律师费用。</p>
					...
					<p>3、您授权择医使用您注册、使用本服务过程中形成的信息，并允许其通过短信、邮件、电话或其他形式向您传送择医提供的服务。您同意接受择医通过短信、邮件、电话或其他形式向您发送活动、服务或其他相关商业信息。如果您不需要择医提供的部分或全部</p>服务的活动、服务或其他相关商业信息的服务，在您向择医客服提出申请后予以中止、终止对您提供的该部分或全部服务。</p>
					...
					<p>6、除非另有明确的书面说明，择医平台及其所包含的或以其它方式通过择医平台提供给您的全部信息、内容、材料、产品（包括软件）和服务，均是在“按现状”和“按现有”的基础上提供的。除非另有明确的书面说明，择医不对择医平台的运营及其包含在择医平台上的信息、内容、材料、产品（包括软件）或服务作任何形式的、明示或默示的声明或担保（根据中华人民共和国法律另有规定的以外）。  7、择医不担保择医平台包含的或以其它方式通过择医平台提供给您的全部信息、内容、材料、产品（包括软件）和服务、其服务器或从择医平台发出的电子信件、信息没有病毒或其他有害成分。如因不可抗力或其它择医平台无法控制的原因使择医平台系统崩溃或无法正常使用导致网上交易无法完成或丢失有关的信息、记录等，择医会合理地尽力协助处理善后事宜。  8、择医平台所承载的内容（文、图、视频、音频）均为传播有益健康资讯目的，不对其真实性、科学性、严肃性做任何形式保证。 </p>
					...
					<p>（6）追问医生个人信息的问题； </p>
					<p>（7）故意挑逗、侮辱医生的提问。 </p>
					<p>6、择医平台所提供的任何各项电子信息，症状自查等服务仅供参考，如自行使用择医平台中资料发生偏差，择医概不负责，亦不负任何法律责任。 </p>
					<p>7、择医保留对本声明作出不定时修改的权利。</p>
					<p>8、择医不对您所发布信息的删除或储存失败负责。择医积极采用数据备份加密等措施保障您数据的安全，但不对由于因意外因素导致的数据损失和泄漏负责。择医有权审查和监督您的行为是否符合本协议的要求，如果您违背了本协议的约定，则择医有权中断您的服务。</p>
					<p>9、您同意因下列情形之一的，择医不承担赔偿责任：</p>
					<p>（1）患者或者其近亲属不配合进行符合诊疗规范的诊疗；</p>
					<p>（2）医务人员在紧急情况下已经尽到合理诊疗义务；</p>
					<p>（3）限于当时的医疗水平难以诊疗。</p>
					<p>10、如果您或第三方就相关服务购买了保险，因发生保险事故导致损失的，保险公司已经向您或第三方承担或许诺承担保险理赔责任后，择医在此范围内不再承担赔偿责任。</p>
