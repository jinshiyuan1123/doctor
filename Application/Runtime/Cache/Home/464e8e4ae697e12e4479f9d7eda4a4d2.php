...
<div class="row"  style="margin-top:10px"></div></div>
		...
		<div class="hy-layout clearfix">
			...
			<div class="clearfix">
			<?php if(is_array($res1)): foreach($res1 as $key=>$val): if($val["sicktime"] == '养生'): if($val["ishospital"] == '是'): ?><a href="<?php echo U('home/index/videolist');?>?id=<?php echo ($val["id"]); ?>" target="_blank">
				<video width="250" height="300" controls autobuffer>
				<source src="/<?php echo ($val["videourl"]); ?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></source>
				</video>
				</a><?php endif; endif; ?>
...
<div class="row"  style="margin-top:10px"></div></div>
		...
		<div class="hy-layout clearfix">
			...
			<div class="clearfix">
			<?php if(is_array($res2)): foreach($res2 as $key=>$val): if($val["sicktime"] == '减肥'): if($val["ishospital"] == '是'): ?><a href="<?php echo U('home/index/videolist');?>?id=<?php echo ($val["id"]); ?>" target="_blank">
				<video width="250" height="300" controls autobuffer>
				<source src="/<?php echo ($val["videourl"]); ?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></source>
				</video>
				</a><?php endif; endif; ?>
...
<div class="row"  style="margin-top:10px"></div></div>
		<div class="hy-layout clearfix">
			...
			<div class="clearfix">
				<?php if(is_array($res3)): foreach($res3 as $key=>$val): if($val["sicktime"] == '生活'): if($val["ishospital"] == '是'): ?><a href="<?php echo U('home/index/videolist');?>?id=<?php echo ($val["id"]); ?>" target="_blank">
				<video width="250" height="300" controls autobuffer>
				<source src="/<?php echo ($val["videourl"]); ?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></source>
				</video>
				</a><?php endif; endif; ?>
...
<div class="row"  style="margin-top:10px"></div></div>
		<div class="hy-layout clearfix">
			...
			<div class="clearfix">
				 	<?php if(is_array($res4)): foreach($res4 as $key=>$val): if($val["sicktime"] == '自拍拍'): if($val["ishospital"] == '是'): ?><a href="<?php echo U('home/index/videolist');?>?id=<?php echo ($val["id"]); ?>" target="_blank">
				<video width="250" height="300" controls autobuffer>
				<source src="/<?php echo ($val["videourl"]); ?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></source>
				</video>
				</a><?php endif; endif; ?>
