                    ...
                    <div class="item submit">
                        <div class="contain">
                            <div class="submit-con">
                                ...
                                <p class="submit-guide">提交订单后，请<a href="https://www.guahao.com/intro/userapp" target="_blank" monitor="freeask_ask,freeask_ask,mycenter_ask">下载择医APP</a>或关注择医公众号及时获取医生回复。</p>
                            </div>
                        </div>
                    </div>
                </form>
