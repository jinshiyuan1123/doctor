	...
	<div class="main-box J_MainBox">
			...
			<form action="<?php echo U('home/index/docLogin');?>" onsubmit="return checkPost();" method="post" >
				...
				<ul>
                    ...
                    <li class="auto-login policy-info">
                        登录即表示您已阅读并同意
                        <a href="<?php echo U('home/index/doctorlist');?>" target="_blank">《择医医生注册协议》</a><br>
		...
		<div class="qr-wrapper">
			...
			<div class="qr-show J_QrPanel" style="height:0px;">
				<div class="qr-inner">
					<ul class="g-clear">
						<li><img src="https://img.guahao.com/front/hps-pc-static/img/account/qr-wyd-app.png" alt=""><span>下载择医生APP</span></li>
						<li class="wy-qr"><img src="https://img.guahao.com/front/hps-pc-static/img/account/qr-wyd-weixin.png" alt=""><span>择医生公众号</span></li>
					</ul>
				</div>
			</div>
		</div>
...
function checkPost(){
	...
	$.post("<?php echo U('home/index/checkdoctor');?>",{"mobile":loginId},function(data){
		if(data == 0){
			layer.msg('用户名不存在');
			return false;
		}
