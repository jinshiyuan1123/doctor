...
<script  type="text/javascript">
	...
	GreenLine.Log = {
		...
		requestMethod:'GET',
		loginId:'hnuaNnzHJmwigwWWlsaomd/fZQb7VV/ni5GQxPu7zi95FhVzY0Y1pw==',
		perSessiionId:'15423309907270187250131711',
		shortSessionId:'1542852365733',
		referurl:'https://www.guahao.com/my/consult/list',
...
<div id="g-cfg" data-module="userinfo" class="gp-ucenter g-container" data-fo-help="1">
	<div id="g-breadcrumb">
        <a href="https://www.guahao.com/my/orderlist">个人中心</a>&gt;&nbsp;<a href="https://www.guahao.com/my/orderlist">订单管理</a>&gt;&nbsp;<span>我的申请单</span> 
  	</div>
...
<div class="ucenter-side">
	...
	<div class="side-nav">
			<ul>
				...
				<li class="current"><a href="<?php echo U('home/index/dzyylist');?>" onmousedown="return _smartlog(this,'KYSQ')" monitor="my_list,my_list,my_booking">我的申请单</a></li>
	...
	$GF.push(function(){
		...
		<div class="ucenter-main">
			<div class="ucenter-main-hd">
				<h3>我的申请单</h3>
				<span class="meta">精准预约申请单管理</span>
			</div>
			<ul class="ucenter-main-tabs g-clear">
				<li>
					<a href="/my/dzyy/list" monitor=",freeask,freeask" class="current">精准预约申请</a>
				</li>
			</ul>
			<div class="ucenter-main-data">
				<table class="data-title">
					<tr>
						<td style="width: 120px">就诊人</td>
						<td style="width: 90px">确诊疾病</td>
						<td style="width: 350px">病情描述</td>
						<td style="width: 90px">希望就诊时间</td>
				...
				<div class="noresults">
					<div class="content">
				    	...
				    	<p class="noresults-text">暂无精准预约申请单</p>
					</div>
				</div>
			</div>
		</div>
