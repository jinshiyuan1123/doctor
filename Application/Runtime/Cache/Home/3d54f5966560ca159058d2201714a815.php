                    ...
                    <div class="tab-body verify-main">
                            <div class="action">
                                ...
                                <div class="input-line">
                                    身份证号：<input type="text" name="card" maxlength="18" data-required="1" pattern="^(\d{15}$|\d{18}$|\d{17}(\d|X|x))$" value="<?php echo ($user["card"]); ?>" data-message="请输入正确的身份证号码"><span></span>
                                </div>
                                        ...
                                        <div class="img-wrapper">
                                            <div class="button-box">
                                                <a href="javascript:;" class="J_Btn updateImg select-file">
                                                    ...
                                                    <?php if($pic1 == true): ?><img src="<?php echo ($pic1); ?>" id="previewimg" width="50px" height="40px"/>
                                                        <?php if($user["ispic"] == 1): ?>审核成功<?php else: ?>待审核<?php endif; ?>
                                                    <?php else: ?>
                                                     <img src="" id="previewimg" width="50px" height="40px"/>
                                                    <p class="box-text">点击上传身份证正面照</p><?php endif; ?>
                                                </a>
                                        ...
                                        <div class="img-wrapper">
                                            <div class="button-box">
                                                <a href="javascript:;" class="J_Btn updateImg select-file">
                                                    ...
                                                    <?php if($pic2 == true): ?><img src="<?php echo ($pic2); ?>" id="previewimg1" width="50px" height="40px"/>
                                                        <?php if($user["ispic"] == 1): ?>审核成功<?php else: ?>待审核<?php endif; ?>
                                                    <?php else: ?>
                                                      <img src="" id="previewimg1" width="50px" height="40px"/>
                                                    <p class="box-text">点击上传身份证反面照</p><?php endif; ?>
                                                </a>
                                                <a href="javascript:;" class="del J_Del">删除</a>
                                                <div class="cert-preview g-clear J_CertPreview"></div>
                                            </div>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="img-wrapper">
                                            <div class="button-box">
                                                <a href="javascript:;" class="J_Btn updateImg select-file">
                                                    <i class="addImg"></i>
                                                    <input type="file" name="myFile3" class="upload-input J_CertUpload" onChange="preview2(this)">
                                                     <?php if($pic3 == true): ?><img src="<?php echo ($pic3); ?>" id="previewimg2" width="50px" height="40px"/>
                                                        <?php if($user["ispic"] == 1): ?>审核成功<?php else: ?>待审核<?php endif; ?>
                                                    <?php else: ?>
                                                      <img src="" id="previewimg2" width="50px" height="40px"/>
                                                    <p class="box-text">点击上传证件照</p><?php endif; ?>
                                                </a>
                                                <a href="javascript:;" class="del J_Del">删除</a>
                                                <div class="cert-preview g-clear J_CertPreview"></div>
                                            </div>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="img-wrapper">
                                            <div class="button-box">
                                                <a href="javascript:;" class="J_Btn updateImg select-file">
                                                    <i class="addImg"></i>
                                                    <input type="file" name="myFile4" class="upload-input J_CertUpload" onChange="preview3(this)">
                                                     <?php if($pic4 == true): ?><img src="<?php echo ($pic4); ?>" id="previewimg3" width="50px" height="40px"/>
                                                        <?php if($user["ispic"] == 1): ?>审核成功<?php else: ?>待审核<?php endif; ?>
                                                    <?php else: ?>
                                                      <img src="" id="previewimg3" width="50px" height="40px"/>
                                                    <p class="box-text">点击上传证件照</p><?php endif; ?>
                                                </a>
                                                <a href="javascript:;" class="del J_Del">删除</a>
                                                <div class="cert-preview g-clear J_CertPreview"></div>
