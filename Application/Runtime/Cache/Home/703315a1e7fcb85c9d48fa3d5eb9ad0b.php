...
<script  type="text/javascript">
	...
	function _smartlog(link,mod){return true;};
    					...
    					<link rel="stylesheet" href="https://static.guahao.cn/front/portal-pc-static/css/about-us.css?v=1542352557776f11" type="text/css"/>
...
<div class="gh-nav">
	<div class="container g-clear">
		<div class="g-left">
				...
				<a href="/user/login?target=%2Fagreement%2Fprivacy_policy" rel="nofollow"  onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,login">登录</a>
				<span class="line">|</span>
				<a href="/register/mobile?target=%2Fagreement%2Fprivacy_policy" rel="nofollow" onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,signin">注册</a>
		...
		<div class="list-right">
			<div class="list-right-content">
				...
				<div class="agreementCenter">
                    ...
                    <p class="agreement-title">提示条款</p>
                    <p>
                        您的信任对我们非常重要，我们深知个人信息安全的重要性，我们将按照法律法规要求，采取安全保护措施，保护您的个人信息安全可控。鉴此，微医（或简称“我们”）制定本《法律声明及隐私权政策》（以下或简称“声明和政策”）并提醒您：<br>
                        本政策适用于微医的产品或服务。<span style="text-decoration: underline;">如关联公司（范围详见定义部分）的产品或服务中使用了微医提供的产品或服务（例如直接使用微医账户登录）但未设独立法律声明及隐私权政策的，则本政策同样适用于该部分产品或服务。<br>
                        请您注意，本政策和声明不适用于以下情况：<br>
                        1、通过我们的服务而接入的第三方服务（包括任何第三方网站）收集的信息；<br>
                        2、通过在我们服务中进行广告服务的其他公司或机构所收集的信息。<br>
                        在使用微医的各项服务前，请您务必仔细阅读并透彻理解本《法律声明和隐私权政策》，在确认充分理解并同意后方使用相关产品和服务。一旦您开始使用微医服务，将被视为对本声明和政策内容的接受和认可。<br></span>
                        如对本声明和政策内容有任何疑问、意见或建议，您可通过客服中心（ /help/common ）与我们联系。
                    </p>

                    <p class="agreement-title">定义</p>
                    <p>·微医<br>
                        微医是指微医控股有限公司（We Doctor Holdings Limited）及在中国境内设立挂号网（杭州）科技有限公司、浙江康健绿线网络技术有限公司、绿线（杭州）信息技术有限公司、微医（杭州）集团有限公司、微医集团（浙江）有限公司、杭州广发科技有限公司、杭州萧山微医门诊部有限公司、乌镇互联网医院管理（桐乡）有限公司等多家运营实体。
                    </p>
                    <p>
                        ·微医平台<br>
                    ...
                    <p>
                        ·微医服务提供者<br>
                        指微医的网络及软件技术服务提供者杭州广发科技有限公司、浙江康健绿线网络技术有限公司、挂号网（杭州）科技有限公司
                    </p>
                    <p>
                        ·关联公司<br>
                    ...
                    <h4 class="padding-s" style="text-align: center;">法律声明</h4>
                    <p class="agreement-title">一、权利归属</p>
                    <p>
                    ...
                    <p class="agreement-title">二、责任限制</p>
                    <p>
                    ...
                    <p class="agreement-title">三、知识产权保护</p>
                    <p>
                    ...
                    <h4 class="padding-s" style="text-align: center; margin-bottom: 30px;">隐私权政策</h4>
                    <p>
                        微医（以下或称为“我们”）深知个人信息对您的重要性，并会尽全力保护您的个人信息安 全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。请在使用我们的产品（或服务）前，仔细阅读并了解本隐私权政策，我们将按照本政策收集、处理及披露您的信息。<br>
                        <span style="text-decoration: underline;">本政策将帮助您了解以下内容：<br>
                        1、定义<br>
                        2、我们可能收集的信息<br>
                    ...
                    <p class="agreement-title">一、定义</p>
                    <p>
                        1.1 个人信息<br>
                    ...
                    <p class="agreement-title">二、我们可能收集的信息</p>
                    <p>
                    ...
                    <p class="agreement-title">三、我们如何收集和使用您的个人信息</p>
                    <p>
                    ...
                    <p>
                        ...
                        <span style="text-decoration: underline;">您的登录名包括但不仅限于您的手机号、邮箱账号、用户名，您可以完善昵称、密码、头像、联系地址、出生日期等相关信息，补充这些“账户信息”将有助于我们为您提供更具个性化的服务。<br>
                        您需要向我们提供真实姓名和有效身份证件（包括但不限于身份证、医保卡、护照）的号码和复印件，以便于我们进行实名认证。如果您不提供这些信息，可能会影响您对微医部分核心业务功能的正常使用，如预约挂号等，但不会影响您进行基本的浏览、搜索。<br>
                        如果您不提供这些补充信息，将会影响您使用微医的部分功能，如预约挂号，但不会影响您使用微医产品或服务的基本浏览、搜索功能。</span><br>
                        如成为我们平台的注册医生，您需要提供包括但不仅限于手机号码、邮箱账号、用户名，并创建密码。<span style="text-decoration: underline;">在注册过程中，如您提供以下额外信息，将有助于我们对您的医疗健康服务资格进行认证：您的真实姓名、性别、身份证正反面照片、联系信息（QQ/微信/邮箱地址）、医院电话、《执业医师资格证》、《医师执业证书》、《职称证》、您本人的真实头像。如果您未提供这些信息，将会影响到您在微医进行的互联网医疗健康服务活动。</span><br>
                        在您主动注销账号时，我们将根据相关法律法规的要求尽快使其匿名或删除您的个人信息。
                    </p>
                    <p>
                        3.2 为您展示和推送医疗相关信息和服务<br>
                        <span style="text-decoration: underline;">为改善我们的产品或服务、向您提供个性化的互联网医疗健康服务，我们会根据您的浏览及搜索记录、设备信息、位置信息、历史问诊、个人生理健康信息、关注医生、加入的圈子等，提取您的浏览、搜索偏好、行为习惯、位置信息等特征，基于特征标签进行间接人群画像并展示、推送信息。</span>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        为更好地向您提供互联网医疗健康服务服务，更加精准、快速地向您推荐问诊医生，我们可能需要您在咨询问诊时提供个人健康生理信息，例如：病症、住院志、医嘱单、检验报告、 手术及麻醉记录、护理记录、用药记录、药物食物过敏信息、生育信息、以 往病史、诊治情况、家族病史、现病史、传染病史等，以及与个人身体健康状况产生的相关信息，及体重、身高、肺活量等。如您不提供上述信息，将会影响您使用部分咨询问诊等功能，但不影响您使用微医产品或服务的基本浏览、搜索功能。<br>
                        ...
                        为便于您使用医保卡进行挂号、医疗健康服务费用的支付，您需要提供医保卡号、医保卡绑定的手机号码以及医保支付口令。如您不提供上述信息将无法正常使用医保支付功能。<br>
                    ...
                    <p>
                        ...
                        <span style="text-decoration: underline;">请注意，单独的设备信息、日志信息等是无法识别特定自然人身份的信息。</span>如果我们将这类非个人信息与其他信息结合用于识别特定自然人身份，或者将其与个人信息结合使用，则在结合使用期间，这类非个人信息将被视为个人信息，除取得您授权或法律法规另有规定外，我们会将该类个人信息做匿名化、去标识化处理。<br>
                        为展示您的生理健康信息，我们会收集您在使用我们服务过程中产生的问诊咨询详情（包括但不限于图片、文字、视频、语音）、预约挂号记录、检查检验、用药处方、医生诊断结果等用于向您展示及便于您对信息进行管理。<br>
                        当您与我们联系时，我们可能会保存您的通信/通话记录和内容或您留下的联系方式等信息，以便与您联系或帮助您解决问题，或记录相关问题的处理方案及结果。
                    </p>
                    <p>
                        3.3.3 我们通过间接获得方式收集到的您的个人信息<br>
                        我们可能从第三方获取您授权共享的账户信息（头像、昵称、联系方式），并在您同意声明和隐私后将您的第三方账户与您的账户绑定，使您可以通过第三方账户直接登录并使用我们的产品与/或服务。我们会将依据与第三方的约定、对个人信息来源的合法性进行确认后，在符合相关法律和法规规定的前提下，使用您的这些个人信息。<br>
                        <span style="text-decoration: underline;">您可通过同一账号在我们提供的链接入口使用我们关联公司提供的产品或服务，为便于我们基于关联账号共同向您提供一站式服务并便于您统一进行管理，我们在微医平台集中展示您的信息或推荐您感兴趣的信息。<br>
                        当您通过我们产品或服务使用上述服务时，您授权我们根据实际业务及合作需要从我们关联公司处接收、汇总、分析我们确认其来源合法或您授权同意其向我们提供的您的个人信息或交易信息。<br>
                        如您拒绝提供上述信息或拒绝授权，可能无法使用我们关联公司的相应产品或服务，或者无法展示相关信息，但不影响使用微医的预约挂号、咨询问诊等核心服务。</span>
                    </p>
                    <p>
                        3.4 为您提供安全保障<br>
                        <span style="text-decoration: underline;">请注意，为确保账户身份真实性、向您提供更好的安全保障，您可以向我们提供身份证、社保卡等身份信息，绑定银行卡等完成实名认证。如您拒绝提供上述信息，可能无法预约或问诊特定专家、继续可能存在风险的操作等，但不会影响您使用浏览、搜索等服务。</span><br>
                    ...
                    <p class="agreement-title">四、我们如何使用 Cookie 和同类技术</p>
                    <p>
                        4.1 Cookie<br>
                        ...
                        您可根据自己的偏好管理或删除 Cookie。有关详情，请参见 AboutCookies.org。您可以清除计算机上保存的所有 Cookie，大部分网络浏览器都设有阻止 Cookie 的功能。但如果您这么做，则需要在每一次访问微医平台时更改用户设置。如需详细了解如何更改浏览器设置，请访问您使用的浏览器的相关设置页面。
                    </p>
                    <p>
                        4.2 网站信标和像素标签<br>
                    ...
                    <p class="agreement-title">五、我们如何共享、转让、公开披露您的个人信息</p>
                    <p>
                        5.1 共享<br>
                        ...
                        3、<span style="text-decoration: underline;">与关联公司间共享：为便于我们基于关联账号共同向您提供服务，推荐您可能感兴趣的信息或保护微医关联公司或其他用户或公众的人身财产安全免遭侵害，您的个人信息可能会与我们的关联公司共享。</span>我们只会共享必要的个人信息（如为便于您通过同一账号使用我们关联公司产品或服务，我们会向关联公司共享您必要的账户信息），如果我们共享您的个人敏感信息或关联公司改变个人信息的使用及处理目的，将再次征求您的授权同意。<br>
                        4、<span style="text-decoration: underline;">与授权合作伙伴共享：仅为实现本声明和隐私中声明的目的，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。</span>例如，在您在商城购买我们的产品时，我们必须与物流服务提供商共享您的个人信息才能安排送货，或者安排合作伙伴提供服务。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。<br>
                    ...
                    <p>
                        ...
                        2、在微医服务提供者发生合并、收购或破产清算情形，或其他涉及合并、收购或破产清算情形时，如涉及到个人信息转让，我们会在要求新的持有您个人信息的公司、组织继续受声明和隐私的约束，否则我们将要求该公司、组织重新向您征求授权同意。
                    </p>
                    <p>
                        5.3 公开披露<br>
                        我们仅会在以下情况下，公开披露您的个人信息：<br>
                        1、获得您明确同意或基于您的主动选择，我们可能会公开披露您的个人信息；<br>
                        <span style="text-decoration: underline;">2、如果我们确定您出现违反法律法规或严重违反微医相关协议规则的情况，或为保护微医及其关联公司用户或公众的人身财产安全免遭侵害，我们可能依据法律法规或微医相关协议规则征得您同意的情况下披露关于您的个人信息，</span>包括相关违规行为以及微医已对您采取的措施。例如，若您囤积号源、虚假预约而严重违反用户协议，我们可能会公开披露或与合作方共享您的身份信息、联系方式与处罚情况。
                    </p>
                    <p>
                    ...
                    <p class="agreement-title">六、用户业务数据和公开信息</p>
                    <p>
                    ...
                    <p class="agreement-title">七、我们如何保护您的个人信息</p>
                    <p>
                    ...
                    <p>
                        7.3 我们会采取合理可行的措施，尽力避免收集无关的个人信息。<span style="text-decoration: underline;">我们只会在达成本声明和隐私所述目的所需的期限内保留您的个人信息，除非需要延长保留期或受到法律的允许。</span>
                    </p>
                    <p>
                        ...
                        在使用微医平台进行网上问诊时，您不可避免地要向医务人员或客服披露自己的个人信息，如联系方式或身份信息。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。如您发现自己的个人信息尤其是您的账户或密码发生泄露，请您立即联络客服，以便我们根据您的申请采取相应措施。<br>
                    ...
                    <p class="agreement-title">八、您如何管理您的个人信息</p>
                    <p>
                    ...
                    <p>
                        ...
                        <span style="text-decoration: underline;"> 当您从我们的服务中删除信息后，我们可能不会立即从备份系统中删除相应的信息，但会在备份更新时删除这些信息。</span>
                    </p>
                    <p>
                        8.4 改变您授权同意的范围<br>
                        您可以通过删除信息、关闭设备功能、在微医平台中进行隐私设置等方式改变您授权我们继续收集个人信息的范围或撤回您的授权。<br>
                        请您理解，每个业务功能需要一些基本的个人信息才能得以完成（见本隐私权政策“我们如何收集和使用您的信息”）。当您收回同意后，我们将不再处理相应的个人信息。<span style="text-decoration: underline;">但您收回同意的决定，不会影响此前基于您的授权而开展的个人信息处理。</span>
                    </p>
                    <p>
                        8.5 个人信息主体注销账户<br>
                    ...
                    <p class="agreement-title">九、我们如何处理未成年人的个人信息</p>
                    <p>
                        如果没有父母或监护人的同意，未成年人不得创建自己的用户账户。<span style="text-decoration: underline;">如您为未成年人的，建议您请您的父母或监护人仔细阅读本隐私权政策，并在征得您的父母或监护人同意的前提下使用我们的服务或向我们提供信息。</span><br>
                        对于经父母或监护人同意使用我们的产品或服务而收集未成年人个人信息的情况，我们只会在法律法规允许、父母或监护人明确同意或者保护未成年人所必要的情况下使用、共享、转让或披露此信息。<br>
                        根据当地监管部门的相关规定，微医仅对满足特定年龄要求的用户提供互联网医疗健康服务。
                    </p>

                    <p class="agreement-title">十、您的个人信息如何在全球范围转移</p>
                    <p>
                    ...
                    <p class="agreement-title">十一、本声明和政策如何更新</p>
                    <p>
                        我们的隐私政策可能变更。<br>
                        未经您明确同意，我们不会削减您按照声明和隐私所应享有的权利。 我们会在本页面上发布对本声明和隐私所做的任何变更。<br>
                    ...
                    <p class="agreement-title">十二、如何联系我们</p>
                    <p>
                        以下情况，您可以通过客服中心（ /help/common ）在线客服与我们联系，一般情况下我们将在30个工作日内回复您的请求：<br>
                        1、如对本声明和隐私内容有任何疑问、意见或建议；<br>
                        2、如发现个人信息可能被泄露；<br>
                        如果您对我们的回复不满意，特别是您认为我们的个人信息处理行为损害了您的合法权益，您还可以通过向被告方所在地有管辖权的法院提起诉讼来寻求解决方案。
                    </p>
		...
		<div class="g-left">
			<div class="main-box J_MainBox">
				<div class="nav g-clear">
						<li class="main-current J_MainTab"><span>登录</span>&nbsp;&nbsp;<i>▪</i>&nbsp;&nbsp;<a href="/register/mobile?target=%2Fagreement%2Fprivacy_policy">注册</a></li>
