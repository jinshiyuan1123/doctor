...
<html>
    ...
    <title>注册 | 微医(挂号网)-互联网医院在线诊疗平台</title>
                <meta name="keywords" content="微医注册,挂号网注册" />
                <meta name="description" content="微医（挂号网）登录页面，微医（挂号网）怎么登录使用 - 微医（www.guahao.com）致力于打造实名医患交流的互联网健康服务平台。聚合了全国超过3900家重点医院，建立了全国三级医院30万名医生的专长库，是您合作的首选平台。" />
        ...
        <div class="tab-list">
            <div class="tab-listcon J_TabList">
                        ...
                        <form id="userForm" name="userForm" method="post" onsubmit="return CheckPost();" action="<?php echo U('home/index/Registerfee');?>">
                            ...
                            <ul id="J_FirstPart" >
                                ...
                                <li class="agreement">
                                    ...
                                    <p class="agreement-content policy-info">
                                        <a href="<?php echo U('home/index/argeement');?>" target="_blank" class="Textr">《微医用户注册协议》</a>
                            ...
                            <ul id="J_SecondPart" style="display: none">
                                ...
                                <li class="agreement">
                                    ...
                                    <p class="agreement-content policy-info">
                                        <a href="<?php echo U('/home/index/agreement');?>" target="_blank" class="Textr">《微医用户注册协议》</a>
                                        <a href="<?php echo U('home/index/privacy_policy');?>" target="_blank">《法律声明及隐私权政策》</a>
                                    </p>
                                </li>
                                <li class="action-bar ml105">
                ...
                <div class="tab-download g-clear J_TabDownload">
                    <div class="qr-inner">
                        <ul class="g-clear">
                            <li><img src="https://static.guahao.cn/front/portal-pc-static/img/account/v3/qr-user.png?v=20160307" alt=""><p>下载<a href="https://www.guahao.com/intro/userapp" monitor="scan_download,scan_download,user_app">微医APP</a></p></li>
                            <li class="wy-qr"><img src="https://static.guahao.cn/front/portal-pc-static/img/account/v3/qr-doctor.png?v=20160307" alt=""><p>下载<a href="https://www.guahao.com/intro/drapp" monitor="scan_download,scan_download,doctor_app">微医生APP</a></p></li>
                        </ul>
                    </div>
                </div>
            </div>
