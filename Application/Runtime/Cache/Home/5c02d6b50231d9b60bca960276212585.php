...
<div class="hide">
  <script type="text/javascript">
        ...
        function checkBox(){
            var J_Nextlist = document.getElementById("J_Nextlist");
            ...
            var J_SecondPart = $("#J_SecondPart").css('display','block');

            var J_FirstPart = $("#J_FirstPart").css('display','none');
             document.getElementById("mobile_alias").value = mobile;
    ...
    //发送验证码函数
    function sendsms(e){
    var phone = $('#mobile_alias').val();//手机号码
      $.post( 
