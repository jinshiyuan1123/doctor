...
<head>
	...
	<title>法律声明及隐私权政策 | 择医(挂号网)-互联网医院在线诊疗平台</title>
			   	<meta name="keywords" content="择医法律声明及隐私权政策,挂号网法律声明及隐私权政策" />
			   	<meta name="description" content="择医（挂号网）法律声明及隐私权政策 - 择医（www.guahao.com）致力于打造实名医患交流的互联网健康服务平台。聚合了全国超过3900家重点医院，建立了全国三级医院30万名医生的专长库，是您合作的首选平台。" />
		...
		<div class="list-right">
			<div class="list-right-content">
				...
				<div class="agreementCenter">
                    ...
                    <p class="smallText">
                        您的信任对我们非常重要，我们深知个人信息安全的重要性，我们将按照法律法规要求，采取安全保护措施，保护您的个人信息安全可控。鉴此，择医（或简称“我们”）制定本《法律声明及隐私权政策》（以下或简称“声明和政策”）并提醒您：<br>
                        本政策适用于择医的产品或服务。<span class="underline">如关联公司（范围详见定义部分）的产品或服务中使用了择医提供的产品或服务（例如直接使用择医账户登录）但未设独立法律声明及隐私权政策的，则本政策同样适用于该部分产品或服务。<br>
                        请您注意，本政策和声明不适用于以下情况：<br>
                        1、通过我们的服务而接入的第三方服务（包括任何第三方网站）收集的信息；<br>
                        2、通过在我们服务中进行广告服务的其他公司或机构所收集的信息。<br>
                        在使用择医的各项服务前，请您务必仔细阅读并透彻理解本《法律声明及隐私权政策》，在确认充分理解并同意后方使用相关产品和服务。一旦您开始使用择医服务，将被视为对本声明和政策内容的接受和认可。</span><br>
                        如对本声明和政策内容有任何疑问、意见或建议，您可通过客服中心（ /help/common ）与我们联系。
                    </p>

                    <p class="subTitle">定义</p>
                    <p class="smallText">·择医<br>
                        择医是指择医控股有限公司（We Doctor Holdings Limited）及在中国境内设立挂号网（杭州）科技有限公司、杭州广发科技有限公司、乌镇互联网医院（桐乡）有限公司等多家运营实体。
                    </p>
                    <p class="smallText">
                        ·择医平台<br>
                        指择医网站（域名 guahao.com； guahao.cn）及（域名为 wu.gov.cn； h.gov.cn；d.gov.cn）、择医、择医生等网站及客户端应用程序。
                    </p>
                    <p class="smallText">
                        ·择医服务提供者<br>
                        指择医的网络及软件技术服务提供者杭州广发科技有限公司、择医云（杭州）控股有限公司、挂号网（杭州）科技有限公司
                    </p>
                    <p class="smallText">
                        ·关联公司<br>
                        择医直接或间接控股的公司，参股或形成经营、协作的，具有关联关系的企业。
                    </p>

                    <p class="title">法律声明</p>
                    <p class="subTitle">一、权利归属</p>
                    <p class="smallText">
                        1.1. 择医的Logo、“择医”等文字、图形及其组合，以及择医的其他标识、徽记、择医服务的名称等为择医及其关联公司在中国和其他国家的注册商标。未经择医书面授权，任何人不得以任何方式展示、使用或做其他处理（包括但不限于复制、传播、展示、镜像、上传、下载），也不得向他人表明您有权展示、使用或做其他处理。
                    </p>
                    <p class="smallText">
                        1.2. 择医所有的产品、服务、技术与所有程序（以下或简称“技术服务”）的知识产权均归属于择医或归其权利人所有。
                    </p>
                    <p class="smallText">
                        1.3. 除非择医另行声明，择医拥有在择医网站内发布文档等信息（包括但不限于文字、图形、图片、照片、音频、视频、图标、色彩、版面设计、电子文档）的所有权利（包括但不限于版权、商标权、专利权、商业秘密和其他所有相关权利）。未经择医许可，任何人不得擅自使用如上内容（包括但不限于通过程序或设备监视、复制、转播、展示、镜像、上传、下载择医相关网站或移动应用程序内的任何内容）。被授权浏览、复制、打印和传播属于择医相关网站或移动应用程序内信息内容的，该等内容都不得用于商业目的且所有信息内容及其任何部分的使用都必须包括此权利声明
                    </p>

                    <p class="subTitle">二、责任限制</p>
                    <p class="smallText">
                        2.1. 择医用户在择医平台的论坛、社区以及其他应用上，自行上传、提供、发布相关信息，包括但不限于用户名称、公司名称、联系人及联络信息，相关图片、资讯等，该等信息均由用户自行提供，择医的用户须对其提供的任何信息依法承担全部责任。
                    </p>
                    <p class="smallText">
                        2.2. 择医平台上转载作品（包括论坛内容）出于传递更多信息之目的，并不意味择医赞同其观点或证实其内容的真实性。
                    </p>
                    <p class="smallText">
                        2.3. 择医在此提示，您在使用择医服务期间应当遵守中华人民共和国的法律，不得危害网络安全，不得利用择医的服务从事他人侵犯名誉、隐私、知识产权和其他合法权益的活动。尽管有前述提示，择医不对您使用择医服务的用途和目的承担任何责任。
                    </p>

                    <p class="subTitle">三、知识产权保护</p>
                    <p class="smallText">
                        我们尊重知识产权，反对并打击侵犯知识产权的行为。任何组织或个人认为择医的网页（含www.guahao.com网页内容以及客户端页面）内容（如转载文章、发布的信息等）可能侵犯其合法权益的，可以通过向择医提出书面权利通知，择医将在收到知识产权权利人合格通知后依法尽快处理。
                    </p>

                    <p class="title title-special">隐私权政策</p>
                    <p class="smallText">
                        择医（以下或称为“我们”）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。请在使用我们的产品（或服务）前，仔细阅读并了解本隐私权政策，我们将按照本政策收集、处理及披露您的信息。<br>
                    ...
                    <p class="smallText">
                        1.4 业务数据<br>
                        不同于个人信息，是指择医的用户利用择医的服务上传、下载、分发等通过择医的技术服务处理的数据。
                    </p>
                    ...
                    <p class="smallText">
                        2.1 与个人身份无关<br>
                        当您使用择医的产品或服务时，我们可能收集和汇总诸如用户的来源途径、访问顺序、停留时间等信息，例如记录使用择医的产品或服务的每个用户的来源途径、浏览器软件等。
                    </p>
                    <p class="smallText">
                        2.2 与个人身份有关<br>
                        当您使用择医的产品或服务时，我们可能收集和汇总或要求您提供有关个人身份的信息，例如：<br>
                    ...
                    <p class="smallText">
                        ...
                        您需要向我们提供真实姓名和有效身份证件（包括但不限于身份证、医保卡、护照）的号码和复印件，以便于我们进行实名认证。如果您不提供这些信息，可能会影响您对择医部分核心业务功能的正常使用，如预约挂号等，但不会影响您进行基本的浏览、搜索。<br>
                        如果您不提供这些补充信息，将会影响您使用择医的部分功能，如预约挂号，但不会影响您使用择医产品或服务的基本浏览、搜索功能。<br></span>
                        如成为我们平台的注册医生，您需要提供包括但不仅限于手机号码、邮箱账号、用户名，并创建密码。<span class="underline">在注册过程中，如您提供以下额外信息，将有助于我们对您提供电子服务资格进行认证：您的真实姓名、性别、身份证正反面照片、联系信息（QQ/微信/邮箱地址）、医院电话、《执业医师资格证》、《医师执业证书》、《职称证》、您本人的真实头像。如果您未提供这些信息，将会影响到您在择医进行的电子服务活动。</span><br>
                    ...
                    <p class="smallText">
                        ...
                        为更好地向您提供互联网电子服务，更加精准、快速地向您推荐医生，我们可能需要您在健康咨询时提供个人健康生理信息，例如：病症、住院志、医嘱单、检验报告、手术及麻醉记录、护理记录、用药记录、药物食物过敏信息、生育信息、以往病史、诊治情况、家族病史、现病史、传染病史等，以及与个人身体健康状况产生的相关信息，及体重、身高、肺活量等。如您不提供上述信息，将会影响您使用部分健康咨询等功能，但不影响您使用择医产品或服务的基本浏览、搜索功能。<br>
                        为更好地支付挂号费、医疗健康服务费等费用，使用择医合作金融机构进行理财等服务，您需要提供银行卡号、该卡的预留手机号、身份证号码，并创建账户与支付口令。如您不提供上述信息，将无法正常使用健康账户相关的支付等功能，但不影响您使用择医产品或服务的基本浏览、搜索功能。<br>
                        为更好地支付费用，使用择医合作金融机构进行理财等服务，您需要提供银行卡号、该卡的预留手机号、身份证号码，并创建账户与支付口令。如您不提供上述信息，将无法正常使用健康账户相关的支付等功能，但不影响您使用择医产品或服务的基本浏览、搜索功能。<br>
                        为完成付款，您可能需要提供健康账户账号或其他第三方支付账号并选择付款方式，以便我们了解您的支付状态。<br>
                        为便于您顺利使用择医提供的试用服务，您需要提供联系方式、联系地址与机构相关信息。如您不提供上述信息将会影响您使用择医提供的产品试用。<br>
                        为便于您费用的支付，您需要提供医保卡号、医保卡绑定的手机号码以及医保支付口令。如您不提供上述信息将无法正常使用医保支付功能。<br>
                        您可以通过择医为其他人进行预约或咨询等服务，您需要提供该实际用户的前述个人信息。向择医提供该实际用户的前述个人信息之前，您需确保您已经取得其授权同意。
                    </p>
                    <p class="smallText">
                    ...
                    <p class="smallText">
                        ...
                        <span class="underline">您可通过同一账号在我们提供的链接入口使用我们关联公司提供的产品或服务，为便于我们基于关联账号共同向您提供一站式服务并便于您统一进行管理，我们在择医平台集中展示您的信息或推荐您感兴趣的信息。<br>
                        当您通过我们产品或服务使用上述服务时，您授权我们根据实际业务及合作需要从我们关联公司处接收、汇总、分析我们确认其来源合法或您授权同意其向我们提供的您的个人信息或交易信息。<br>
                        如您拒绝提供上述信息或拒绝授权，可能无法使用我们关联公司的相应产品或服务，或者无法展示相关信息，但不影响使用择医的健康咨询等核心服务。</span>
                    </p>
                    <p class="smallText">
                        3.4 为您提供安全保障<br>
                        ...
                        为提高您使用我们及我们关联公司、合作伙伴提供服务的安全性，保护您或其他用户或公众的人身财产安全免遭侵害，更好地预防钓鱼网站、欺诈、网络漏洞、计算机病毒、网络攻击、网络侵入等安全风险，更准确地识别违反法律法规或择医相关协议规则的情况，我们可能使用或整合您的账户信息、交易信息、设备信息、有关网络日志以及我们关联公司、合作伙伴取得您授权或依据法律共享的信息，来综合判断您账户及交易风险、进行身份验证、检测及防范安全事件，并依法采取必要的记录、审计、分析、处置措施。
                    </p>
                    <p class="smallText">
                        3.5 其他用途<br>
                    ...
                    <p class="smallText">
                        ...
                        11、法律法规规定的其他情形。<br>
                        如我们停止运营择医的产品或服务，我们将及时停止继续收集您个人信息的活动，将停止运营的通知以逐一送达或公告的形式通知您，对所持有的个人信息进行删除或匿名化处理。
                    </p>
                    <p class="smallText">
                        3.7 设备权限调用<br>
                    ...
                    <p class="smallText">
                        ...
                        您可根据自己的偏好管理或删除Cookie。有关详情，请参见 AboutCookies.org。您可以清除计算机上保存的所有 Cookie，大部分网络浏览器都设有阻止 Cookie 的功能。但如果您这么做，则需要在每一次访问择医平台时更改用户设置。如需详细了解如何更改浏览器设置，请访问您使用的浏览器的相关设置页面。
                    </p>
                    <p class="smallText">
                        4.2 网站信标和像素标签<br>
                    ...
                    <p class="smallText">
                        5.1 共享<br>
                        我们不会与择医服务提供者以外的任何公司、组织和个人分享您的个人信息，但以下情况除外：<br>
                        1、在获取明确同意的情况下共享：获得您的明确同意后，我们会与其他方共享您的个人信息。<br>
                        2、我们可能会根据法律法规规定，或按政府主管部门的强制性要求，对外共享您的个人信息。<br>
                        3、与关联公司间共享：<span class="underline">为便于我们基于关联账号共同向您提供服务，推荐您可能感兴趣的信息或保护择医关联公司或其他用户或公众的人身财产安全免遭侵害，您的个人信息可能会与我们的关联公司共享。</span>我们只会共享必要的个人信息（如为便于您通过同一账号使用我们关联公司产品或服务，我们会向关联公司共享您必要的账户信息），如果我们共享您的个人敏感信息或关联公司改变个人信息的使用及处理目的，将再次征求您的授权同意。<br>
                    ...
                    <p class="smallText">
                        ...
                        2、在择医服务提供者发生合并、收购或破产清算情形，或其他涉及合并、收购或破产清算情形时，如涉及到个人信息转让，我们会在要求新的持有您个人信息的公司、组织继续受声明和政策的约束，否则我们将要求该公司、组织重新向您征求授权同意。
                    </p>
                    <p class="smallText">
                        5.3 公开披露<br>
                        我们仅会在以下情况下，公开披露您的个人信息：<br>
                        1、获得您明确同意或基于您的主动选择，我们可能会公开披露您的个人信息；<br>
                        <span class="underline">2、如果我们确定您出现违反法律法规或严重违反择医相关协议规则的情况，或为保护择医及其关联公司用户或公众的人身财产安全免遭侵害，我们可能依据法律法规或择医相关协议规则征得您同意的情况下披露关于您的个人信息，</span>包括相关违规行为以及择医已对您采取的措施。例如，若您囤积号源、虚假预约而严重违反用户协议，我们可能会公开披露或与合作方共享您的身份信息、联系方式与处罚情况。
                    </p>
                    <p class="smallText">
                    ...
                    <p class="smallText">
                        不同于您的个人信息，对于用户业务数据和公开信息，择医将按如下方式处理：
                    </p>
                    <p class="smallText">
                        6.1 用户业务数据<br>
                        1、您通过择医平台提供的服务，加工、存储、上传、下载、分发以及通过其他方式处理的数据，均为您的用户业务数据，您完全拥有您的用户业务数据。择医作为服务提供商，我们只会严格执行您的指示处理您的业务数据，除按与您协商一致或执行明确的法律法规要求外，不对您的业务数据进行任何非授权的使用或披露。<br>
                        2、您应对您的用户业务数据来源及内容负责，择医提示您谨慎判断数据来源及内容的合法性。因您的用户业务数据内容违反法律法规、部门规章或国家政策而造成的全部结果及责任均由您自行承担。<br>
                        3、根据您与择医协商一致，择医在您选定的数据中心存储用户业务数据。择医恪守对用户的安全承诺，根据适用的法律保护用户存储在择医数据中心的数据。
                    </p>
                    <p class="smallText">
                        6.2 公开信息<br>
                        1、公开信息是指您公开分享的任何信息，任何人都可以在使用和未使用择医服务期间查看或访问这些信息。例如您在社区、论坛发布的信息。<br>
                        2、为使用择医的产品或服务，可能存在您必须公开分享的信息。<br>
                        3、在使用择医平台进行交易时，您不可避免的要向交易对方或潜在的交易对方披露自己的个人信息，如联络方式或者邮政地址。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。您也可以通过我们的服务建立联系和相互分享。当您通过我们的服务创建交流、交易或分享时，您可以自主选择沟通、交易或分享的对象，作为能够看到您的联络方式、交流信息或分享内容等相关信息的第三方。如您发现自己的个人信息泄漏，尤其是您的账户或密码发生泄露，请您立即联络客服，以便择医采取相应措施。
                    </p>

                    <p class="subTitle">七、我们如何保护您的个人信息</p>
                    <p class="smallText">
                        7.1 我们已采取符合业界标准、合理可行的安全防护措施保护您提供的个人信息安全，防止个人信息遭到未经授权访问、公开披露、使用、修改、损坏或丢失。例如，在您的浏览器与服务器之间交换数据（如信用卡信息）时受 SSL（Secure Socket Layer）协议加密保护；我们同时对择医相关网站提供HTTPS（Hyper Text Transfer Protocol over Secure Socket Layer）协议安全浏览方式；我们会使用加密技术提高个人信息的安全性；我们会使用受信赖的保护机制防止个人信息遭到恶意攻击；我们会部署访问控制机制，尽力确保只有授权人员才可访问个人信息；以及我们会举办安全和隐私保护培训课程，加强员工对于保护个人信息重要性的认识。但请您理解，由于技术的限制以及可能存在的各种恶意手段，在互联网行业，即便竭尽所能加强安全措施，也不可能始终保证信息百分之百的安全。您需要了解，您接入我们的服务所用的系统和通讯网络，有可能因我们可控范围外的因素而出现问题。
                    </p>
                    <p class="smallText">
                    ...
                    <p class="smallText">
                        7.4 互联网并非绝对安全的环境，我们强烈建议您不要使用非择医推荐的通信方式发送个人信息。您可以通过我们的服务建立联系和相互分享。当您通过我们的服务创建交流、交易或分享时，您可以自主选择沟通、交易或分享的对象，作为能够看到您的交易内容、联络方式、交流信息或分享内容等相关信息的第三方。<br>
                        在使用择医平台进行网上健康咨询时，您不可避免地要向医务人员或客服披露自己的个人信息，如联系方式或身份信息。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。如您发现自己的个人信息尤其是您的账户或密码发生泄露，请您立即联络客服，以便我们根据您的申请采取相应措施。<br>
                    ...
                    <p class="smallText">
                        7.5 我们将不定期更新并公开安全风险、个人信息安全影响评估报告等有关内容，您可通过择医平台公告方式获得。
                    </p>
                    <p class="smallText">
                    ...
                    <p class="smallText">
                        ...
                        健康档案信息：您可以在择医 APP 中查阅或清除您的问诊咨询记录、预约挂号记录等。<br>
                    ...
                    <p class="smallText">
                        8.4 改变您授权同意的范围<br>
                        您可以通过删除信息、关闭设备功能、在择医平台中进行隐私设置等方式改变您授权我们继续收集个人信息的范围或撤回您的授权。<br>
                    ...
                    <p class="smallText">
                        8.5 个人信息主体注销账户<br>
                        在符合择医单项服务的服务协议约定条件及国家相关法律法规规定的情况下，您的该项择医服务帐号可能被注销或删除。当帐号注销或被删除后，与该帐号相关的、该单项服务项下的全部服务资料和数据将依照单项服务的服务协议约定删除或匿名化处理。
                    </p>
                    <p class="smallText">
                        8.6 约束信息系统自动决策<br>
                        在某些业务功能中，我们可能仅依据信息系统、算法等在内的非人工自动决策机制做出决定。如果这些决定显著影响您的合法权益，您有权要求我们做出解释，我们也将在不侵害择医商业秘密或其他用户权益、社会公共利益的前提下提供申诉方法。
                    </p>
                    <p class="smallText">
                        8.7 响应您的上述请求<br>
                    ...
                    <p class="smallText">
                        ...
                        根据当地监管部门的相关规定，择医仅对满足特定年龄要求的用户提供电子服务。
                    </p>
