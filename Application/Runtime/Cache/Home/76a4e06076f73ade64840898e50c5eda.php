...
<div id="g-cfg" class="gp-internet" data-module="gaoduan">
    <div class="contaiwner g-clear" style="    position: relative;
    width: 1200px;
    margin: 0 auto 20px;
    zoom: 1;
    background-color: #fff;">
        ...
        <div class="grid-right" style="display: block;">
            <a class="lo1ve seo-anchor-text" target='_blank'
