...
<script  type="text/javascript">
	...
	GreenLine.Log = {
		...
		requestMethod:'GET',
		loginId:'lzUSc3HDMtCD0ZsZy5lmj4JORkYCC0BLKtuqgPC18XiGOuYf0zNwLw==',
		perSessiionId:'15423309907270187250131711',
		shortSessionId:'1542852365733',
		referurl:'https://www.guahao.com/my/orderlist',
...
<style>
	#gm-delete .title a{
        background:url(https://static.guahao.cn/img/v2/hp2.png?_=20140624) -99px -124px no-repeat #F8F8F8;
        position: absolute;
        right: 12px;
        top: 12px;
        height: 15px;
    ...
    #gm-delete .title a:hover{
        background: url(https://static.guahao.cn/img/v2/hp2.png?_=20140624) -90px -150px no-repeat #F8F8F8;
        position: absolute;
        right: 8px;
        top: 8px;
        height: 25px;
    ...
    #gm-delete .body i{
    	background: url('https://static.guahao.cn/front/portal-pc-static/img/usercenter/what.png');
    	width:46px;
    	height:45px;
...
<div id="g-cfg" data-module="userinfo" class="gp-ucenter g-container J_PurchaseList" data-fo-help="1">
	<div id="g-breadcrumb">
        <a href="https://www.guahao.com/my/orderlist">个人中心</a>&gt;&nbsp;<a href="https://www.guahao.com/my/orderlist">订单管理</a>&gt;&nbsp;<span>购药订单</span> 
  	</div>
...
<div class="ucenter-side">
	...
	<div class="side-nav">
			<ul>
				...
				<li class="current" ><a href="<?php echo U('home/index/drugorderlist');?>" monitor="my_list,my_list,my_drugorder">购药订单</a></li>
			</ul>
			<ul>
	...
	$GF.push(function(){
		...
		<div class="ucenter-main">
			<div class="ucenter-main-hd">
				<h3>购药订单</h3>
				<span class="meta">在线购药，送药到家！</span>
				<a href="https://www.guahao.com/my/goods/list" ><span class="manageAddress">管理收货地址</span></a>
			</div>
			<div class="ucenter-main-data">
				<table class="data-title">
					<tr>
						<td style="width: 440px">
							<p class="data-inline drug-name">药品名称</p>
							<p class="data-inline drug-price">单价</p>
							<p class="data-inline drug-num">数量</p>
						</td>
						<td style="width: 220px">金额</td>
...
<div class="gm-box" id="gm-delete" style="width: 500px; height: 300px; margin-left: -260px; display: none;">
    <div class="title" style="background-color:#f8f8f8;">
        <span style="font-size: 16px;color:#000;">温馨提示</span>
        <a class="close gm-close" href="javascript:;"></a>
    </div>
    <div class="body">
    	<i></i>
    	<div style="font-size:24px;color:#333333;text-align:center;line-height:64px;padding-top:70px;">
    		确认删除订单?
    	</div>
        <div style="text-align: center;">
            <a href="javascript:;" class="gbn gbt-blue1 J_CancelOk">确认</a>
