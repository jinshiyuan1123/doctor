...
<script  type="text/javascript">
	...
	GreenLine.Log = {
		...
		requestMethod:'GET',
		loginId:'R6tBXf8I45vpK1ej7+3Vxx/Bh7GY1MQqX9a7WYWYF8lF1pWjwyMJEQ==',
		perSessiionId:'15423309907270187250131711',
		shortSessionId:'1542856607254',
		referurl:'https://www.guahao.com/my/welfare?type=2',
...
<div  id="g-cfg" data-module="userinfo" class="gp-ucenter g-container">
	<div id="person-plus-list">
		<div id="g-breadcrumb">
	        <a href="https://www.guahao.com/my/orderlist">个人中心</a><a href="https://www.guahao.com/my/orderlist">&gt;&nbsp;钱包福利</a><span>&gt;&nbsp;我的心意</span>
	  	</div>
		<div class="wrap">
...
<div class="ucenter-side">
	...
	<div class="side-nav">
			...
			<ul>
				...
				<li class="current"><a href="<?php echo U('home/index/yzwylist');?>" monitor="my_list,my_list,my_givegift">我的心意</a></li>
...
<script type="text/javascript">
	$GF.push(function(){
		$.ajax({
			...
			<div class="person-right ucenter-main ucenter-heart">
				<div class=" g-clear">
					<div class="meta ucenter-main-hd">
						<h3>我赠送的心意</h3>
						<div class="count-info meta">0个医生&nbsp;&nbsp;&nbsp;&nbsp;0份心意</div>
					</div>
				</div>
							<div class="noresults">
        						<div class="content">
          							<img src="https://static.guahao.cn/front/portal-pc-static/img/dzyy/noapply.png">
					    			<p class="noresults-text">暂无赠送心意</p>
					    		</div>
					   	 	</div>
				</div>
			<div class="clear"></div>
