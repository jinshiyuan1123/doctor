	...
	<div class="">
		...
		<div class="list-right">
			<div class="list-right-content">
				<div class="right-title">版权声明</div> 
			    <div class="top-content">
			    	<p class="padding-s">本网站所有资料均为择医网运营方独家版权所有，未经许可不得转载或镜像；如择医网对部分内容有特别声明的，从其声明。</p>
				　　<p>用户在择医网所发表的合法言论、文章及图片的版权除特别说明外均归原作者和择医网运营方共同所有。该等内容受著作权法、商标法等法律的保护。未经择医网或原文作者书面许可（法律法规规定除外）任何第三方不得擅自使用该些内容，不得擅自复制、剪辑和编辑这些内容、或创造与内容有关的派生产品；</p>
					<p>本网站所有产品、技术及应用程序均为择医网运营方知识产权，未经择医网许可，任何人不得擅自以非法的方式复制、传播、展示、镜像、上载、下载使用，或通过非常规方式影响择医网网站的正常运营；任何人不得擅自以软件程序自动获得择医网网站数据。否则，择医网将依法追究法律责任。</p>
					<p>任何第三方经合法授权后转载择医网上述内容的必须注明“来源于择医网”。 </p>
					<p>择医网未注明“择医网”的图片、文章等信息为转载或由用户发表。择医网转载出于传递更多信息之目的，用户发表的内容仅是用户个人的意见，本条所述内容均不意味着择医网赞同其观点或已证实其内容的真实性。</p>
					<p>任何单位或个人认为择医网或择医网链接内容可能涉嫌侵犯其合法权益的，应该及时与本网站的管理员进行书面反馈，并提供身份证明、权属证明及详细侵权情况证明，本网站在收到上述文件并经确认属实后，将会尽快移除被控侵权的内容或链接。 </p>
			  	</div>				
				<div class="title-img">
