...
<head>
    ...
    <title>医生说｜糖尿病也能治愈！它的最佳治愈期你错过了吗？ - 微医（挂号网）</title>
    <meta charset="utf-8">
...
<div class="g-header">
    <div class="g-header-box">
        <a href="https://www.guahao.com/" ><img class="g-logo"src="https://static.guahao.cn/bbs/img/wy-logo-s1.png"/></a>
        <div class="g-login">
        ...
        <div class="g-article">
            <div class="g-wenzhang">
                <div class="g-title">
                    ...
                    <span class="span-title">医生说｜<?php echo ($reslist["inspection_name"]); ?></span>
                </div>
                <div class="g-time">
            ...
            <div class="g-doctor">
                <div class="g-jianjie">
                    ...
                    <div class="doc-jianjie doc-scroll">
                        <label>简介:</label>
                        <span>微医官方健康号，专家医生深度科普，一篇文章讲透一个疾病。</span>
                    </div>
                ...
                <div class="g-doc-article">
                    ...
                    <hr  class="lin-sx">
                    <div class="arc-list">
                            <a class="arc-label" href="" target="_blank">
                                <div class="d-arc-text">
                                <span class="arc-text">
                                        <span class="arc-icon"></span>
                                医生说｜脾胃不好膏方来调！冬季进补正当时
                                </span>
                                </div>
                ...
                <div class="g-doc-article">
                    ...
                    <div class="arc-list">
                            ...
                            <a class="arc-label" href="" target="_blank">
                                ...
                                <span class="arc-hover">
                                昨天，一条令人震惊而又悲痛的消息传遍了整个网络：央视著名主持人李咏去...
                                    <span class="arc-all">全文</span>
                                </span>
                            </a>
                                <hr  class="lin-xx">
                            <a class="arc-label" href="" target="_blank">
                                ...
                                <span class="arc-hover">
                                最近杭州一则“女子被不栓狗绳的狗主人殴打至骨折”的新闻引发舆论关注。...
                                    <span class="arc-all">全文</span>
                                </span>
                            </a>
                    </div>
    ...
    <div id="gf">
        <div class="g-container">
                <div class="g-footer g-clear">
                    ...
                    <div class="links g-left">
                        <dl class="one g-clear">
                            ...
                            <dd><a href="https://www.guahao.com/nav">网站地图</a></dd>
                        </dl>
                        <dl class="two">
                            <dd class="partner"><a href="https://www.guahao.com/hospital/partnerinfo">医院合作</a></dd>
                            <dd class="help"><a href="https://www.guahao.com/help/common" rel="nofollow">客服中心</a></dd>
                        </dl>
                        <div class="clear"></div>
                    </div>
                ...
                <div style="width:300px;margin:0 auto; padding:20px 0;">
                    <a target="_blank" href="" rel="nofollow" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="/Public/home/images/ghs.png" style="float:left;"><p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393;">浙公网安备 33010902000463号</p></a>
                </div>
        </div>
    </div>
</div>
