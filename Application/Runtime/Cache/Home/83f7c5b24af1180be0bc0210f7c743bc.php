...
<div class="g-container new-account-ui new-doctor-register J_NewRegister" id="gc" data-module="account">
	...
	<div class="main-box J_MainBox">
		<div class="box-header g-clear">
			...
			<div class="g-left title">医院注册</div>
		...
		<div class="form-container doctor-register-suc">
			<form id="userForm" name="userForm" method="post" action="">
				<div class="top-tips">
					<p class="success-tips"><span class="blue-text">注册成功，<?php echo ($true_name); ?>医院欢迎加入择医网，择医因你更精彩！</span></p>
				</div>
				<p class="middle-tips">您的账号是<span class="account"><?php echo ($mobile); ?></span>&nbsp;&nbsp;此账号可同时登录择医，择医生APP</p>
				<a class="btn btn-success btn-lg enter-home" href="<?php echo U('home/index/yydoctorhome');?>">进入择医网</a>
				<div class="bottom-info g-clear">
					<div class="g-left">
						<img src="https://img.guahao.com/portal_upload/qrlogo/qrDrapp1.jpg" onerror="this.src='http://www.guahao.com/qrcode/gener?qrIndex=qrDrapp1';this.removeAttribute('onerror');" />
					</div>
					<div class="g-left">
						<p>扫码下载“择医网”客户端，择医网，<br/>品牌医生的移动诊室！</p>
					</div>
				</div>
			</form>
		</div>
...
<script  type="text/javascript">
	...
	$GLog = {
		requestMethod:'POST',
		loginId:'k2RuCJd/JdRIDYDws0DZwxiJla5rD11gqT3Un/1wF9s8THjPcAXKIA==',
		perSessiionId:'154303338518820178067151',
		shortSessionId:'',
		referurl:'https://doctor.guahao.com/register/doctor/submit',
