...
<script  type="text/javascript">
	...
	GreenLine.Log = {
		...
		requestMethod:'GET',
		loginId:'GEqzm3cPsUfQoRCFYmx9eD0Dj0A1kHfTL6gi8468OPUyXJkOLbcGJg==',
...
<div class="ucenter-side">
	...
	<div class="side-nav">
			...
			<ul>
				...
				<li class="current"><a href="<?php echo U('home/index/welfare');?>" monitor="my_list,my_list,my_welfar">我的优惠券</a></li>
	...
	$GF.push(function(){
		...
		<div class="person-right ucenter-main">
				<div class="g-clear">
					...
					<h3>我的优惠券</h3>
				   <span class="meta">管理我的优惠券</span>
					</div>
				</div>
				<div class="border-left g-common-list">
					
			        <div class="list coupon-box ucenter-main-data">
			         <div class="exchange">
	<p>兑换优惠券：</p> 
	<input type="text" name="exchangeId" placeholder="请输入兑换码" maxlength="14" id="J_ExchangeCode" /> 
	<input name='csrf_token' type='hidden' value='2qw2su86pqhv'>
	<span href="javascript:void(0)" data-action="https://www.guahao.com/json/black/coupon/pcexchange" id="J_CouponExchange">验证券码</span> 
	<a href="javascript:;" id="J_ShowExchangeRule">兑换规则</a>
</div>
<div class="exchangeRule" id="J_ExchangeRule">
	<a href="javascript:;" class="close" id="J_HideExchangeRule"></a>
	<h4>优惠券兑换规则:</h4>
	<div class="line">
		<p><span class="red">Q</span>什么是兑换码?</p>
		<p class="answer"><span class="blue">A</span>兑换码是由微医或与微医合作的商家发放给用户的，作为兑换微医优惠券的凭证，成功兑换后，将以优惠券的形式保存至微医个人账户“我的优惠券”中，优惠券的使用规则详见优惠券规则页面。</p>
	</div>
	<div class="line">
		<p><span class="red">Q</span>怎样使用兑换码？</p>
		<p class="answer"><span class="blue">A</span>兑换码是一串中文、数字、字母或是前几者的组合。将券码准确输入兑换框验证后即可成功兑换。兑换码未兑换前可转赠他人使用。</p>
	</div>
	<div class="line">
		<p><span class="red">Q</span>怎样获得兑换码?</p>
		<p class="answer"><span class="blue">A</span>兑换码是由微医或各商家合作发出的，它们会出现在这些地方：<br/>
	      &emsp;&nbsp;1、微医的官方网站、官方微信公众号<br/>
	      &emsp;&nbsp;2、合作商家官网、微信公众号、官方微博<br/>
	      &emsp;&nbsp;3、其它任何途径<br/>
	      &emsp;&nbsp;<span>温馨提示：每种兑换码的名额有限，大家看到后要第一时间领取哦</span></p>
	</div>
	<div class="line">
		<p><span class="red">Q</span>一个用户一天能兑换几次兑换码?</p>
		<p class="answer"><span class="blue">A</span>一个兑换码对应一张优惠券，用户每天可多次兑换优惠券，优惠券的具体使用规则详见优惠券规则页面。</p>
	</div>
	<div class="line">
		<p><span class="red">Q</span>兑换码可以重复兑换码?</p>
		<p class="answer"><span class="blue">A</span> 不能哦。一个兑换码只能兑换一张优惠券，不能重复兑换。</p>
	</div>
	<div class="line">
		<p><span class="red">Q</span>什么是优惠码的有效期?</p>
		<p class="answer"><span class="blue">A</span>兑换码所兑换成的优惠券上会注明“有效期”，该优惠券只能在注明的有效期内使用</p>
	</div>
</div>
<ul class="coupon-type J_Change">
	<li class="active" data-state="1">可使用</li>
	<li  data-state="2">已失效</li>
</ul>

<form action="/my/welfare?type=2" method="post" id="form">
	<input type="hidden" name="useStatus" class="J_UseState" value="">
</form>

<div class="coupon-list J_CouponList">
	<ul>
		...
		<li >
			<div class="coupon coupon-gold">
				<div class="top">
					<div class="l-box">
						<span class="locus gold">平台</span>
						<p class="price">
					...
					<div class="box">
						...
						<div class="text">
							<p>满49元使用 </p>
							<p class="time"> 有效期至2018-12-05</p>
						</div>
					</div>
					<i class="coupon coupon-tip-XXXXX"></i>
				</div>
				<div class="bottom">
					<span>仅限严选使用 
					</span> </br>
		...
		<li class="noright">
			<div class="coupon coupon-sky">
				<div class="top">
					<div class="l-box">
						<span class="locus sky">平台</span>
						<p class="price">
								8.<b class="dotnumber">5</b><span>折<span>
						</p>
					</div>
					<div class="box">
						<p class="type">问诊劵</p>
