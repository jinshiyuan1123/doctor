...
<div class="gh-nav">
	<div class="container g-clear">
		<div class="g-left">
				...
				<a href="https://www.guahao.com/user/login?target=%2Fforget%2FfindPwd" rel="nofollow"  onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,login">登录</a>
				<span class="line">|</span>
				<a href="https://www.guahao.com/register/mobile?target=%2Fforget%2FfindPwd" rel="nofollow" onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,signin">注册</a>
...
<div id="g-cfg" class="template-style progress-style gp-findps-tel" data-module="account">
	...
	<div class="template-content g-clear">
		<div class="main-content">
			   <form action="<?php echo U('home/index/docfindbymobile');?>" id="findPsFormMobile"  method="post">
				    ...
				    <ul>
						...
						<li class="captcha">
						 ...
						 <li class="action">
					    	<label>&nbsp;</label>
					    	<input type="submit" value="下一步" class="gbn gbt-green" />
    ...
    function countdown(e){
     ...
     $(function () {
     	$("#submitButtom").click(function(){
     		...
     		window.location.href ='http://www.sou.com/index.php/home/index/docfindbymobile';
     	});
     });
	</script>  
</div>
