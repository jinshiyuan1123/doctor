...
<div class="gh-nav">
	<div class="container g-clear">
		<div class="g-left">
				...
				<a href="https://www.guahao.com/user/login?target=%2Fforget%2Freset" rel="nofollow"  onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,login">登录</a>
				<span class="line">|</span>
				<a href="https://www.guahao.com/register/mobile?target=%2Fforget%2Freset" rel="nofollow" onmousedown="return _smartlog(this,'TOP')" monitor="public_head,publick_head,signin">注册</a>
   ...
   <div class="g-progressbar" id="progressbarDv">
	...
	<div class="template-content g-clear">
		<div class=" main-content">   
	        ...
	        <div class="rSuccess">
				<p >新密码重置成功</p>
				<p >请使用新密码<a href="<?php echo U('/home/index/login');?>" class="blueTextr">重新登录</a></p>
			</div>
		</div>
