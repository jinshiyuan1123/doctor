...
<script  type="text/javascript">
	...
	GreenLine.Log = {
		...
		requestMethod:'GET',
		loginId:'tVyEK3bd6snaqgeG67ah9PZ6DnsxX1xb8THauBqpxM3cfLme09K9wQ==',
		perSessiionId:'15423309907270187250131711',
		shortSessionId:'1542856607254',
		referurl:'https://www.guahao.com/my/patients',
...
<div  id="g-cfg" data-module="userinfo" class="gp-ucenter g-container" >
	<div id="g-breadcrumb">
        <a href="https://www.guahao.com/my/orderlist">个人中心</a>&gt;&nbsp;<a href="https://www.guahao.com/my/orderlist">健康档案</a>&gt;&nbsp;<span>我的关注</span> 
  	</div>
...
<div class="ucenter-side">
	...
	<div class="side-nav">
			...
			<ul>
				...
				<li class="current" ><a href="<?php echo U('home/index/favoritelist');?>" monitor="my_list,my_list,my_follow">我的关注</a></li>
			</ul>
			<ul>
...
<script type="text/javascript">
	$GF.push(function(){
		...
		<div class="ucenter-main">
			<div class="ucenter-main-hd" id="myFav-Tabs">
				<h3>我的关注</h3>

				<span class="meta">医生0</span>
				<span class="meta">科室0</span>
				<span class="meta">医院0</span>
			</div>
			<ul class="ucenter-main-tabs g-clear">
				<li>
					        <a href="https://www.guahao.com/my/favorite/list?type=1" class="current"   data-index="1">医生</a>

				</li>
				<li>
					        <a href="https://www.guahao.com/my/favorite/list?type=2"  data-index="2">科室</a>
				</li>
				<li>

					        <a href="https://www.guahao.com/my/favorite/list?type=3"  data-index="3">医院</a>
				</li>
			</ul>
			<div class="ucenter-main-data">
				<div class="data-content" id="myFav-list">
						<div class="noresults">
							<div class="content">
