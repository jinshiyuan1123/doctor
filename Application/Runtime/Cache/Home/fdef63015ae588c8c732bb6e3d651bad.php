          ...
          <li id="panelHover1" class="tabpanel">
              ...
              <table class="find_prfs_table" width="0" border="0">
                  ...
                  <tr>
                    ...
                    <th scope="row"><a href="" title="内科">内科</a> > </th>
                    <?php if(is_array($ksname)): foreach($ksname as $key=>$val): if($val["ksname"] == '内科'): ?><td class="doctor">
                      <a href="<?php echo U('home/index/yishen');?>?id=<?php echo ($val["id"]); ?>" title="<?php echo ($val["true_name"]); ?>"  ><?php echo ($val["true_name"]); ?></a>
                  ...
                  <tr>
                    ...
                    <th scope="row"><a href="" title="外科">外科</a> > </th>
                    <?php if(is_array($ksname)): foreach($ksname as $key=>$val): if($val["ksname"] == '外科'): ?><td class="doctor">
                      <a href="" title="<?php echo ($val["true_name"]); ?>"  ><?php echo ($val["true_name"]); ?></a>
                   ...
                   <tr>
                    ...
                    <th scope="row"><a href="" title="妇科">妇科</a> > </th>
                    <?php if(is_array($ksname)): foreach($ksname as $key=>$val): if($val["ksname"] == '妇科'): ?><td class="doctor">
                      <a href="" title="<?php echo ($val["true_name"]); ?>"  ><?php echo ($val["true_name"]); ?></a>
                   ...
                   <tr>
                    ...
                    <th scope="row"><a href="" title="其他">其他</a> > </th>
                    <?php if(is_array($ksname)): foreach($ksname as $key=>$val): if($val["ksname"] == '其他'): ?><td class="doctor">
                      <a href="" title="<?php echo ($val["true_name"]); ?>"  ><?php echo ($val["true_name"]); ?></a>
