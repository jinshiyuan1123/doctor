...
function like(id) {
	...
	likeID = id
	ajaxPostReq('http://www.sou.com/public/php/like.php',{'id':id,'like':likes,'time':get_time()},{"1":'感谢您的支持！','0':"您已支持过了~"},voids)
}
...
function submit_pl(cname) {
	...
	data.time = time
	ajaxPostReq('http://www.sou.com/public/php/add.php',data,{'0':'评论失败','1':'评论成功'},reflash)
}
...
function start(mode) {
	ajaxInitReq('http://www.sou.com/public/php/handler.php',{'m':mode},render)
}